...
export const metadata: Metadata = {
  ...
  keywords: [
    "Евгений Левчук",
    "Yevgeniy Levchuk",
    "персональный эдвайзер Казахстан",
    "сопровождение для руководителей",
    "психология бизнеса Алматы",
    "эдвайзер для предпринимателей Астана",
    "поиск смыслов в бизнесе",
    "кризис руководителя что дальше",
    "внутренняя опора лидера",
    "экзистенциальный коучинг",
    "честный разговор о себе",
    "executive coaching Kazakhstan"
  ],
  openGraph: {
