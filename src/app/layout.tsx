...
export const metadata: Metadata = {
  ...
  description: "Место для тех, кто устал от шума и готовых ответов. Помогаю найти свои смыслы в моменты, когда старые правила перестали работать. Без спешки. Без чужих схем.",
