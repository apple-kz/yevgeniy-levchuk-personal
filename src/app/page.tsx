      ...
      <section className="min-h-screen flex flex-col justify-center items-center px-8 relative -mt-32">
        <div className="w-full max-w-[1200px] lg:w-max">
          ...
          <div className="text-xl md:text-2xl text-[color:var(--color-muted)] font-light mb-16 space-y-3 leading-relaxed md:whitespace-nowrap">
            ...
            <p>Меня зовут Евгений Левчук. Я предлагаю индивидуальную работу - медленно, внимательно, без готовых ответов.</p>
        ...
        <div className="max-w-[680px] mx-auto">
          <div className="text-xl md:text-2xl text-[color:var(--color-muted)] font-light leading-relaxed space-y-4">
            ...
            <p className="pt-2">
              ...
              без спешки и когда устал от чужих ожиданий.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-32 px-8 bg-[color:var(--color-alt)] transition-colors duration-400">
        <div className="max-w-[680px] mx-auto text-left">
          ...
          <div className="text-lg md:text-xl text-[color:var(--color-muted)] font-light leading-relaxed space-y-8">
            <p>
              Я не коуч с методологией и не терапевт с протоколом. Я индивидульный психолог для предпринимателей, который много лет работает рядом с людьми в важные моменты их жизни.
            </p>
            <p>
              За эти годы я работал с группами и один на один, много путешествовал. Как консультант в Алматы и по всему миру, я видел, как люди устроены в разных культурах. Это даёт мне широкий контекст.
            </p>
      ...
      <section className="py-32 px-8">
        <div className="max-w-[680px] mx-auto text-left">
          ...
          <div className="text-lg md:text-xl text-[color:var(--color-muted)] font-light leading-relaxed space-y-4">
            ...
            <p>Но я умею создавать пространство и предлагать помощь в поиске себя, где этот момент становится возможным.</p>
      ...
      <section className="py-32 px-8 bg-[color:var(--color-inverted-bg)] text-[color:var(--color-inverted-fg)] transition-colors duration-400">
        <div className="max-w-[680px] mx-auto text-left">
          ...
          <div className="text-lg md:text-xl font-light leading-relaxed space-y-6">
            ...
            <p className="opacity-70">Часто это владельцы бизнеса в поиске новых смыслов или те, кто проживает кризис среднего возраста и ищет психолога, способного понять масштаб их задач.</p>
        ...
        <div className="max-w-[680px] mx-auto text-left">
          ...
          <div className="space-y-16">
            <FormatItem title="Одна встреча · 50-60 минут">
              <p>Разовая консультация, чтобы разобраться в конкретной ситуации<br />или просто почувствовать, как я работаю.</p>
            </FormatItem>

            <FormatItem title="Системная работа · от 5 встреч">
              <p>Системная работа с психологом. Диагностика, настройка, сопровождение.<br />Для тех, кто готов идти вглубь - без спешки.</p>
            </FormatItem>

            <FormatItem title="Для руководителей · 90 минут">
              <p>Взгляд со стороны на бизнес-задачу или решение. Эмоциональный интеллект, лидерство, ответственность. Без корпоративного языка. Без готовых ответов.</p>
            </FormatItem>
          </div>
      ...
      <section className="py-32 px-8 bg-[color:var(--color-alt)]">
        <div className="max-w-[680px] mx-auto text-left">
          <h2 className="text-3xl md:text-4xl mb-12 font-serif tracking-tight text-[color:var(--color-fg)]">
            Вопросы психологу, которые обычно возникают
          </h2>
          <div className="space-y-12">
            ...
            <div>
              ...
              <p className="text-lg text-[color:var(--color-muted)] font-light leading-relaxed">
                Не в клиническом смысле. Я помогаю, когда всё хорошо, но что-то не так - работаю с людьми, у которых что-то важное перестало ощущаться своим.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-lg text-[color:var(--color-muted)] font-light leading-relaxed">
                Да. Большинство приходит с запросом "чувствую что живу не своей жизнью" или "не знаю чего хочу от жизни". Отсутствие чёткой формулировки - это честная точка входа.
              </p>
            </div>
            <div>
      ...
      <footer id="contact" className="pt-32 pb-16 px-8 border-t border-[color:var(--color-line)]">
        <div className="max-w-[680px] mx-auto text-center">
          ...
          <div className="text-lg font-light text-[color:var(--color-muted)] mb-16 space-y-2">
            <p>Ваш психолог в Казахстане. Я отвечаю лично.</p>
          </div>
